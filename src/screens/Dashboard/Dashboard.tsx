          ...
          <CardContent className="flex flex-col items-center">
            <div className="relative w-[258px] h-[129px]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pt-8">
                <div className="font-bold text-primary-color text-[44px] mt-4">
                  65%
                </div>
                <div className="font-normal text-[#8496a8] text-sm text-center">
          ...
          <CardContent className="flex flex-col items-center">
            <div className="relative w-[258px] h-[129px]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pt-8">
                ...
                <div className="font-normal text-secondary-color text-sm text-center">
                  Readiness Level
                </div>
              </div>
            </div>
